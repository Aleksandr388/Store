namespace Shared.Constants
{
    ...
    {
        public const string RegistrationFailedNoEmailInModel = "Registation failed no email in model";
        public const string RegistrationFailedNoFirstNameInModel = "Registration failed no first name in model";
        public const string RegistrationFailedNoLastNameInModel = "Registration failed no last name in model";
        ...
        public const string ImpossibleToCreateNewAuthor = "Impossible to create an author, you must indicate at least one";
        ...
        public const string ModelAlredyBeenDeleted = "Model has already been deleted";
        public const string RemoveIsFailed = "The remove model is empty";
        public const string TheListIsEmpty = "The list is empty";
        public const string UpdatedModelIsNull = "The updatet model is null";
        public const string NoUsersWithThisId = "No users with this Id";
        public const string NoUsersWithThisEmail = "No users with this email";
        public const string UserWithThisEmialNotRegiste = "User with this email is not registered";
